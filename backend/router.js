 ...
 * 即提供接口路由供前端页面使用，然后在路由内部，我们接收到前端请求后，再发送 HTTP 请求
 * 到第三方服务接口，携带相应的请求参数，包括签名的参数字段等等。
  ...
  app.get('/api/getSingerDetail', (req, res) => {
    ...
    const data = JSON.stringify({
      ...
      singerSongList: {
        ...
        param: { order: 1, singerMid: req.query.mid, begin: 0, num: 100 }, // num: 10 可以看no-result组件显示
